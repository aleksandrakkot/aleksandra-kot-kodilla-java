package com.crud.kodillapatterns2.aop.calculator;
...
public class Watcher {
    ...
    @Before("execution(* com.crud.kodillapatterns2.aop.calculator.Calculator.factorial(..))" +
    ...
    @Around("execution(* com.crud.kodillapatterns2.aop.calculator.Calculator.factorial(..))")
